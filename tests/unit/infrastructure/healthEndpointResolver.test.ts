...
describe('healthEndpointResolver', () => {
  it('keeps the direct health endpoint on localhost:5173 integration origins', () => {
    expect(
      ...
      configuredUrl: 'http://127.0.0.1:8899/v1/health',
      browserUrl: 'http://127.0.0.1:8899/v1/health',
