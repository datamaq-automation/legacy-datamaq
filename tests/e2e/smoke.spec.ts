...
test.describe('Smoke E2E', () => {
  test.beforeEach(async ({ page }) => {
    const healthRoutes = ['**/api/v1/health.php', '**/plantilla-www/public/api/v1/health.php']
    ...
    const pricingRoutes = ['**/api/v1/pricing.php', '**/plantilla-www/public/api/v1/pricing.php']
    ...
    const contentRoutes = ['**/api/v1/content.php', '**/plantilla-www/public/api/v1/content.php']
    ...
    const contactRoutes = ['**/api/v1/contact.php', '**/plantilla-www/public/api/v1/contact.php']
    for (const pattern of contactRoutes) {
      await page.route(pattern, fulfillContactApi)
    }

    const mailRoutes = ['**/api/v1/mail.php', '**/plantilla-www/public/api/v1/mail.php']
